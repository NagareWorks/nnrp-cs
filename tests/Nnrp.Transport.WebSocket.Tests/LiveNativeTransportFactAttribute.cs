...
namespace Nnrp.Transport.WebSocket.Tests
{
    ...
    internal sealed class LiveNativeTransportFactAttribute : FactAttribute
    {
        ...
        internal const string ArtifactPathVariableName = "NNRP_NATIVE_WEBSOCKET_ARTIFACT_PATH";
        ...
        public LiveNativeTransportFactAttribute()
        {
            ...
            {
                Skip = $"Set {EnableVariableName}=1 to run native WebSocket provider tests.";
            }
        }
    }
}
