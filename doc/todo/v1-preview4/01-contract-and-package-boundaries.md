...
- [x] Pin the coordinated Rust artifact `1.0.0-preview.4.26` and exact FFI ABI `4.4.0` in build and release metadata.
- [x] Validate the TCP, QUIC, IPC, and WebSocket artifact manifests from `1.0.0-preview.4.26`.
