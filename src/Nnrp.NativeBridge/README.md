...
Nnrp.NativeBridge provides managed bindings and packaged native assets for NNRP transport bridges.

Use this package when you want the managed client surface plus packaged native bridge assets for native transport connectivity.
