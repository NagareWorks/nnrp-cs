...
def build_release_readme(version: str) -> str:
    return textwrap.dedent(
        ...
        This package contains the NNRP Preview4 client, core, NativeBridge, and all four provider assemblies plus
        transport-scoped native plugins generated by CI. It never contains the server role or NuGet runtime layout.
